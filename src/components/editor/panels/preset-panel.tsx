...
const PRESETS: PresetEntry[] = [
  { id: "radial-waveform", name: "Radial Waveform", category: "waveform", tier: "free" },
  { id: "linear-bars", name: "Linear Bars", category: "waveform", tier: "free" },
  { id: "linear-dots", name: "Linear Dots", category: "waveform", tier: "free" },
  { id: "particle-storm", name: "Particle Storm", category: "particles", tier: "free" },
  { id: "neon-ring", name: "Neon Ring", category: "waveform", tier: "free" },
  { id: "minimal-wave", name: "Minimal Wave", category: "minimal", tier: "free" },
  { id: "skyline", name: "Skyline", category: "waveform", tier: "free" },
  { id: "sphere-3d", name: "3D Sphere", category: "3d", tier: "pro" },
  { id: "crossing-bolts", name: "Crossing Bolts", category: "particles", tier: "pro" },
  { id: "glitter-storm", name: "Glitter Storm", category: "particles", tier: "pro" },
  { id: "forest-lights", name: "Forest Lights", category: "particles", tier: "pro" },
  { id: "magma-flow", name: "Magma Flow", category: "retro", tier: "pro" },
  { id: "neon-tunnel", name: "Neon Tunnel", category: "3d", tier: "pro" },
  { id: "trap-nation", name: "Trap Nation", category: "waveform", tier: "free" },
];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 rounded-lg border border-blue-500/30 p-2">
          {PRESETS.map((preset) => (
            <button
              key={preset.id}
